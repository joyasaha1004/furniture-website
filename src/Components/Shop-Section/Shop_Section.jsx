...
<div className="text-center relative -top-[320px] text-sm sm:-top-[320px] md:text-lg md:-top-[420px] lg:text-2xl lg:-top-[500px] xl:-top-[530px]">
                    <h1 className="text-3xl leading-snug px-2 text-sky-500 font-bold sm:text-4xl sm:leading-snug md:text-5xl md:leading-snug  lg:text-6xl lg:leading-snug xl:text-7xl xl:px-6"> Shop Our Curated Furniture Collection</h1>
