...
<div className="text-center relative bg-shop_bg pt-24 pb-7 sm:pb-10 md:pb-24 lg:pb-36 bg-cover bg-center text-xs md:pt-28 lg:text-base lg:pt-44 xl:pt-52 xl:text-lg xxl:text-xl">
                    ...
                    <p className="text-white px-2 mt-2 leading-relaxed sm:px-16 md:px-20  lg:px-28 lg:mt-4 xl:px-72"> Discover stylish, quality furniture crafted to elevate any room. Shop our collection to find the perfect pieces that blend comfort, elegance, and timeless design for your space.</p>
